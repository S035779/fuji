...
class CalculatorIf : virtual public  ::SharedServiceIf {
 public:
...
class CalculatorIfFactory : virtual public  ::SharedServiceIfFactory {
 public:
...
class CalculatorNull : virtual public CalculatorIf , virtual public  ::SharedServiceNull {
 public:
...
class CalculatorClient : virtual public CalculatorIf, public  ::SharedServiceClient {
 public:
  CalculatorClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::SharedServiceClient(prot, prot) {}
  CalculatorClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::SharedServiceClient(iprot, oprot) {}
...
class CalculatorProcessor : public  ::SharedServiceProcessor {
 protected:
  ::apache::thrift::stdcxx::shared_ptr<CalculatorIf> iface_;
...
class CalculatorMultiface : virtual public CalculatorIf, public  ::SharedServiceMultiface {
 public:
...
class CalculatorConcurrentClient : virtual public CalculatorIf, public  ::SharedServiceConcurrentClient {
 public:
  CalculatorConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::SharedServiceConcurrentClient(prot, prot) {}
  CalculatorConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::SharedServiceConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
