...
class ItemServiceIfSingletonFactory : virtual public ItemServiceIfFactory {
 public:
  ItemServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<ItemServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<ItemServiceIf> iface_;
};
...
class ItemServiceClient : virtual public ItemServiceIf {
 public:
  ItemServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ItemServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class ItemServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  ItemServiceProcessor(::apache::thrift::stdcxx::shared_ptr<ItemServiceIf> iface) :
    iface_(iface) {
...
class ItemServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  ItemServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< ItemServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< ItemServiceIfFactory > handlerFactory_;
};

class ItemServiceMultiface : virtual public ItemServiceIf {
 public:
  ItemServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<ItemServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~ItemServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<ItemServiceIf> > ifaces_;
  ItemServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<ItemServiceIf> iface) {
...
class ItemServiceConcurrentClient : virtual public ItemServiceIf {
 public:
  ItemServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ItemServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
